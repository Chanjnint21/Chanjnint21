...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?size=15&duration=6000&color=6ABEFF&lines=When+nothing+goes+right%2C+go+left.;Impossible+is+for+the+unwilling.;%22Take+the+risk+or+lose+the+chance.;If+you+want+it%2C+work+for+it.;If+you%E2%80%99re+going+through+hell%2C+keep+going.;Fall+seven+times%2C+stand+up+eight.;Failure+is+success+if+we+learn+from+it.;And+so%2C+The+adventure+begin..." alt="Typing SVG" /></a>
